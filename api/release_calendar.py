...
Confirmed against model-history transition dates: CPI 2026-07-14 and
2026-09-11, GDP 2026-06-25 and 2026-07-30.
...
_FOMC_2026 = [  # decision day (second day of the meeting)
...
RELEASES: list[dict] = sorted(
    _rows("CPI", _CPI_2026) + _rows("GDP", _GDP_2026) + _rows("FOMC", _FOMC_2026) + _rows("SLOOS", _SLOOS_2026),
    key=lambda r: r["date"],
)
